...
[![CLI Version](https://img.shields.io/badge/CLI-v2.8.3-00ADD8?logo=go&logoColor=white)](https://github.com/waftester/waftester/releases/tag/v2.8.3) <!-- x-cli-version -->
...
| `version` | Installed WAFtester version | `2.8.3` |
