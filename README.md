...
[![CLI Version](https://img.shields.io/badge/CLI-v2.9.1-00ADD8?logo=go&logoColor=white)](https://github.com/waftester/waftester/releases/tag/v2.9.1) <!-- x-cli-version -->
...
| `version` | Installed WAFtester version | `2.9.1` |
