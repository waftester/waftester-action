...
[![CLI Version](https://img.shields.io/badge/CLI-v2.9.25-00ADD8?logo=go&logoColor=white)](https://github.com/waftester/waftester/releases/tag/v2.9.25) <!-- x-cli-version -->
...
| `version` | Installed WAFtester version | `2.9.25` |
...
- uses: waftester/waftester-action@v1.0.33
...
# Replace with actual SHA from: git rev-parse v1.0.33
